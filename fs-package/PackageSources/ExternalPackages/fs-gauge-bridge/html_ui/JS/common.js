...
class ImportTemplateElement extends HTMLElement {
    ...
    connectedCallback() {
        if (this.hasAttribute("href")) {
            console.log("importing from elemenet " + this.getAttribute("href"));
...
(function (Include) {
    ...
    class IncludeMgr {
        ...
        requestScript(_def) {
          //  console.log("requestScript " + _def.path);
        ...
        onScriptLoaded(_def) {
          //  console.log("onScriptLoaded " + _def.path);
            var found = false;
            for (var i = 0; i < this.scriptList.length; i++) {
        ...
        isLoadingScript(_pattern) {
          //  console.log("IS LOADING? " + _pattern);
