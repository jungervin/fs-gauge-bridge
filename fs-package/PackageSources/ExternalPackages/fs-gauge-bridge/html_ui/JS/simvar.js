...
(function (SimVar) {
    ...
    function GetSimVars() {
        if (!Coherent || !Coherent.isAttached)
            return null;
        if (!window)
            return null;
        if (window.frameElement) {
            return window.top["simvar"];
        }
        return window["simvar"];
    }
    function GetGlobalVars() {
        if (!Coherent.isAttached)
            return null;
        if (window.frameElement) {
            return window.top["globalvar"];
        }
    ...
    function GetGameVars() {
        if (!Coherent.isAttached)
            return null;
        if (window.frameElement) {
            return window.top["gamevar"];
        }
        return window["gamevar"];
    }
    class SimVarValue {
        ...
        try {
            ...
            if (Simvars) {
                switch (unit.toLowerCase()) {
                    ...
                    default: return Coherent.call("setValue_Number", name, unit, value, dataSource);
                }
            }
            else
